...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">seiva-visual documentation</a>
                </li>
                                ...
                                <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-3d61cd564db5fc0246f389b745a89d57"' : 'data-target="#xs-components-links-module-AppModule-3d61cd564db5fc0246f389b745a89d57"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-3d61cd564db5fc0246f389b745a89d57"' :
                                            'id="xs-components-links-module-AppModule-3d61cd564db5fc0246f389b745a89d57"' }>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/BotaoLateralComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">BotaoLateralComponent</a>
                                            </li>
                                            <li class="link">
                                                <a href="components/BotaoSubirComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">BotaoSubirComponent</a>
                                            </li>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/HomeInicioComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">HomeInicioComponent</a>
                                            </li>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/PostagemTemaComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">PostagemTemaComponent</a>
                                            </li>
                                            <li class="link">
